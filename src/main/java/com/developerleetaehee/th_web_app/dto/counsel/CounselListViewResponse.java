...
@Getter
@Schema(description = "고객 상담 신청 타임리프 응답 DTO")
public class CounselListViewResponse {
    ...
    public CounselListViewResponse(Counsel counsel, CounselCustomCode codeMap) {
        ...
        this.registerDatetime = counsel.getRegisterDatetime();
    }
